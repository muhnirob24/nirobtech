<?php
    // Module: Digital Forensic Lab - API Endpoint
    // Handles AJAX requests for Digital Forensic Lab module.
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['action'])) {
        ...
        $model = new forensic-lab_Model(); // Instantiate the module's model
        ...
        switch ($action) {
            ...
            case 'get_details':
                ...
                break;
            // Add more GET API actions specific to Digital Forensic Lab
            default:
                $response['message'] = 'Unknown GET action.';
        }
    } elseif ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
        $action = sanitize_input($_POST['action']);
        $model = new forensic-lab_Model();
        ...
        switch ($action) {
            case 'save_item':
                ...
                break;
            // Add more POST API actions specific to Digital Forensic Lab
            default:
