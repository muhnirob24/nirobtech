<?php
    // Module: Cyber Defense & Hacking Lab - API Endpoint
    // Handles AJAX requests for Cyber Defense & Hacking Lab module.
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['action'])) {
        ...
        $model = new cyber-defense_Model(); // Instantiate the module's model
        ...
        switch ($action) {
            ...
            case 'get_details':
                ...
                break;
            // Add more GET API actions specific to Cyber Defense & Hacking Lab
            default:
                $response['message'] = 'Unknown GET action.';
        }
    } elseif ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
        $action = sanitize_input($_POST['action']);
        $model = new cyber-defense_Model();
        ...
        switch ($action) {
            case 'save_item':
                ...
                break;
            // Add more POST API actions specific to Cyber Defense & Hacking Lab
            default:
